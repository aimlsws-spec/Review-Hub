...
const STORAGE_KEY = 'rh-merchant-auth'
const REMEMBER_KEY = 'rh-merchant-remember'
...
export const useAuthStore = create<AuthState>()(
  persist(
    (set) => ({
      ...
      setAuth: (user, merchant, accessToken, refreshToken, rememberMe = false) => {
        ...
        set({ user, merchant, accessToken, refreshToken, isAuthenticated: true })
      },
